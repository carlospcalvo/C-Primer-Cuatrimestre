...
int hardcodearTrabajos( eTrabajo vec[], int tam, int cantidad)
{
    ...
    eTrabajo suplentes[]=
    {
        { 1, 123456, 20001, {15,10,2019}},
        { 2, 123789, 20000, {20,8,2019}},
        { 3, 456789, 20002, {9,9,2019}},
        { 4, 123123, 20002, {31,5,2019}},
        { 5, 123789, 20003, {10,8,2019}},
        { 6, 101010, 20001, {1,10,2019}},
        { 7, 456789, 20003, {27,9,2019}},
        { 8, 110011, 20001, {20,7,2019}},
        { 9, 222222, 20000, {1,7,2019}},
        { 10, 110011, 20002, {30,8,2019}},
        { 11, 123123, 20001, {15,9,2019}},
        { 12, 123456, 20003, {2,10,2019}},
        { 13, 101010, 20000, {10,10,2019}},
        { 14, 110011, 20003, {4,9,2019}},
        { 15, 222222, 20002, {9,9,2019}}
    };
